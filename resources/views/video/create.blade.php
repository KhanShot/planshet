...
@section('content')
    ...
    <div>
        <form method="post"  class="d-flex dropzone" action="{{ route('video.store') }}" enctype="multipart/form-data">
            <div class="col-md-5">
                <div class="d-flex align-items-center mr-5 mt-3 mb-4">
                    <a href="{{route('campaigns')}}" class="btn btn-outline-dark p-0 mr-3 border-radius-20 border-0 background-white">
                    ...
                    <h2 class="mt-2">Новый place holder</h2>

                </div>

                @csrf
                <div class="form-group">
                    <input name="name" type="text" required class="form-control border-radius-20  pl-4 pr-4 pt-2 pb-2" placeholder="Название ролика">
                </div>
            ...
            <div class="col-md-7 w-100 back-image">
                <input type="file" accept="video/*" required class="my-pond h-100" name="video"/>
            </div>
        </form>
    </div>
