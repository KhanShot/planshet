...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                <div class="mr-2">Тип: </div>
                <p> {{$video->is_placeholder ? 'Заставка' : 'Клиент, ' . $video->advertiser->company_name ?? 'Клиент' }}</p>
            </div>
            <div class="d-flex">
                <div class="mr-2">Длительность: </div>
                <p> {{$video->duration}} c</p>
            </div>
            <div class="d-flex">
                <div class="mr-2">Кол-во планшетов: </div>
                <p> {{ $data['tablet_count'] }}</p>
            </div>
            <div class="d-flex">
