    ...
    <div class="d-flex">
        <div class="col-md-5">
            ...
            <form method="post" action="{{ route('advertisers.store') }}">
                ...
                <div class="form-group">
                    <input name="phone" required class="form-control border-radius-20  pl-4 pr-4 pt-2 pb-2" placeholder="+7 (___)___-__-__">
                </div>
                <div class="form-group">
        ...
        <div class="col-md-7 w-100 back-image" style="background: url('/assets/images/ALA.jpg')">
