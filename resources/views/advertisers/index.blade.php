...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mr-5">
        <h2 class="mt-4">Рекламодатели</h2>
        <a href="{{route('advertisers.create')}}" class="btn btn-outline-dark border-radius-20 border-0 background-white">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-outline-dark border-0" href="{{route('advertisers.edit', $advertiser->id)}}"><i class="fa fa-pen-to-square"></i></a>

                            <a href="{{route('advertisers.detail', $advertiser->id)}}" class="btn btn-outline-dark border-0 "> <svg class="icon-hover" width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
